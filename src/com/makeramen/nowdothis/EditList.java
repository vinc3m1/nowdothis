...
public class EditList extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		prefs = this.getSharedPreferences(ItemView.PREFS_KEY, 0);
		catString = prefs.getString(ItemView.LIST_KEY, "take a nap\nbuy pen\norganize room");
	...
	public void onClick(View v) {
		...
		case R.id.savebutton:
			...
			editor.putString(ItemView.LIST_KEY, mEditText.getText().toString());
			editor.commit();
		case R.id.cancellink:
			this.startActivity(new Intent(this, ItemView.class));
			this.finish();
			break;
		}
	}
